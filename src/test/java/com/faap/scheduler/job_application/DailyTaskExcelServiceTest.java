 ...
 */
public class DailyTaskExcelServiceTest 
    extends TestCase
{
     ...
     */
    public DailyTaskExcelServiceTest( String testName )
    {
        super( testName );
    }
    ...
    public static Test suite()
    {
        ...
        TestSuite testSuite = new TestSuite( DailyTaskExcelServiceTest.class );
        return testSuite;
    }
